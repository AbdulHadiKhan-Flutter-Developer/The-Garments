...
class SingleCategoryDetailScreen extends StatelessWidget {
  final ProductsModel productmodel;

  SingleCategoryDetailScreen(this.productmodel);
        ...
        child: Container(
          child: Row(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  await checkItemExistance(UId: user!.uid);
                },
                child: Text(
                  'Add to cart',
                  style: TextStyle(
  ...
  Future<void> checkItemExistance(
    ...
    if (documentSnapshot.exists) {
      ...
      CartModel cartModel = CartModel(
        ...
        ProductTotalPrice: double.parse(
          productmodel.issale ? productmodel.SalePrice : productmodel.FullPrice,
        ),
      );
